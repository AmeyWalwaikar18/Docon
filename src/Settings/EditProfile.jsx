...
export default function EditProfile() {
  ...
  console.log("heya",user,user?.additionalDetails);
  return (
    <>
      <form onSubmit={handleSubmit(submitProfileForm)}>
        {/* Profile Information */}
        <div className="my-10 flex flex-col gap-y-6 rounded-md border-[1px] border-richblack-700 text-slate-300 bg-slate-800 p-8 px-12">
          ...
          <div className="flex flex-col gap-5 lg:flex-row">
            ...
            <div className="flex flex-col gap-2 lg:w-[48%]">
              <label
                htmlFor="lastName"
                className="lable-style text-left ml-1  text-[14px] text-richblack-5"
              >
                Last Name
              </label>
              <input
          ...
          <div className="flex flex-col gap-5 lg:flex-row">
            <div className="flex flex-col gap-2 lg:w-[48%]">
              ...
              <input
                ...
                defaultValue={user?.additionalDetails?.height}
              />
              {errors.height && (
                <span className="-mt-1 text-[12px] text-yellow-100">
            ...
            <div className="flex flex-col gap-2 lg:w-[48%]">
              ...
              <input
                ...
                defaultValue={user?.additionalDetails?.weight}
              />
              {errors.weight && (
                <span className="-mt-1 text-[12px] text-yellow-100">
        ...
        <div className="flex justify-end gap-2 text-richblack-50">
          <button
            ...
            className="cursor-pointer rounded-md bg-slate-500 py-2 px-5 font-normal text-slate-100"
          >
            Cancel
          </button>
