...
const { SENDOTP_API, SIGNUP_API, LOGIN_API, DOCTORS_API } = endpoints;
...
export function getDoctorDetails() {
  return async (dispatch) => {
    ...
    // dispatch(setLoading(true));
    try {
      const response = await apiConnector("GET", DOCTORS_API);

      console.log("Get all users api", response.data.Users);
